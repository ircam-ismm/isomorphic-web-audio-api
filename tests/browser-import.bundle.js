...
// browser.js
var OfflineAudioCompletionEvent = globalThis.OfflineAudioCompletionEvent;
var AudioProcessingEvent = globalThis.AudioProcessingEvent;
var BaseAudioContext = globalThis.BaseAudioContext;
var AudioContext = globalThis.AudioContext;
var OfflineAudioContext = globalThis.OfflineAudioContext;
var AudioNode = globalThis.AudioNode;
var AudioScheduledSourceNode = globalThis.AudioScheduledSourceNode;
var AudioParam = globalThis.AudioParam;
var AudioDestinationNode = globalThis.AudioDestinationNode;
var AudioListener = globalThis.AudioListener;
var AudioWorklet = globalThis.AudioWorklet;
var AudioParamMap = globalThis.AudioParamMap;
var PeriodicWave = globalThis.PeriodicWave;
var AudioBuffer = globalThis.AudioBuffer;
var ScriptProcessorNode = globalThis.ScriptProcessorNode;
var AudioWorkletNode = globalThis.AudioWorkletNode;
var AnalyserNode = globalThis.AnalyserNode;
var AudioBufferSourceNode = globalThis.AudioBufferSourceNode;
var BiquadFilterNode = globalThis.BiquadFilterNode;
var ChannelMergerNode = globalThis.ChannelMergerNode;
var ChannelSplitterNode = globalThis.ChannelSplitterNode;
var ConstantSourceNode = globalThis.ConstantSourceNode;
var ConvolverNode = globalThis.ConvolverNode;
var DelayNode = globalThis.DelayNode;
var DynamicsCompressorNode = globalThis.DynamicsCompressorNode;
var GainNode = globalThis.GainNode;
var IIRFilterNode = globalThis.IIRFilterNode;
var MediaStreamAudioSourceNode = globalThis.MediaStreamAudioSourceNode;
var OscillatorNode = globalThis.OscillatorNode;
var PannerNode = globalThis.PannerNode;
var StereoPannerNode = globalThis.StereoPannerNode;
var WaveShaperNode = globalThis.WaveShaperNode;
var mediaDevices = globalThis.navigator.mediaDevices;

// tests/browser-import.js
describe("node imports", () => {
  it(`should re-export all classes`, () => {
    assert.notEqual(OfflineAudioCompletionEvent, void 0);
    assert.notEqual(AudioProcessingEvent, void 0);
    assert.notEqual(BaseAudioContext, void 0);
    assert.notEqual(AudioContext, void 0);
    assert.notEqual(OfflineAudioContext, void 0);
    assert.notEqual(AudioNode, void 0);
    assert.notEqual(AudioScheduledSourceNode, void 0);
    assert.notEqual(AudioParam, void 0);
    assert.notEqual(AudioDestinationNode, void 0);
    assert.notEqual(AudioListener, void 0);
    assert.notEqual(AudioWorklet, void 0);
    assert.notEqual(AudioParamMap, void 0);
    assert.notEqual(PeriodicWave, void 0);
    assert.notEqual(AudioBuffer, void 0);
    assert.notEqual(ScriptProcessorNode, void 0);
    assert.notEqual(AudioWorkletNode, void 0);
    assert.notEqual(AnalyserNode, void 0);
    assert.notEqual(AudioBufferSourceNode, void 0);
    assert.notEqual(BiquadFilterNode, void 0);
    assert.notEqual(ChannelMergerNode, void 0);
    assert.notEqual(ChannelSplitterNode, void 0);
    assert.notEqual(ConstantSourceNode, void 0);
    assert.notEqual(ConvolverNode, void 0);
    assert.notEqual(DelayNode, void 0);
    assert.notEqual(DynamicsCompressorNode, void 0);
    assert.notEqual(GainNode, void 0);
    assert.notEqual(IIRFilterNode, void 0);
    assert.notEqual(MediaStreamAudioSourceNode, void 0);
    assert.notEqual(OscillatorNode, void 0);
    assert.notEqual(PannerNode, void 0);
    assert.notEqual(StereoPannerNode, void 0);
    assert.notEqual(WaveShaperNode, void 0);
    assert.notEqual(mediaDevices, void 0);
  });
});
